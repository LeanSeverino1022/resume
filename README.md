I found this really good [project by WebPraktikos](https://github.com/WebPraktikos/universal-resume) and I used it as a starting point to create good resumes for my friends. I love the typograhy, it's simplicity, and that the origincal project already uses tailwind CSS. I made modifications to the NPM packages used, design, and code.
...
process tailwind CSS. output file is then build.css

```
npm run build
```

Currently I have 'live-server' installed globally on my computer and if I want to run the original resume design then, from the root folder I do

```
live-server public
```

or view other resume examples
```
live-server public\rene
```
